...
// import "./App.css"; // We'll add animation styles here
...
//     const newUserMsg = { role: "user", text: userInput, time: new Date() };
...
//         body: JSON.stringify({ message: newUserMsg.text, session_id }),
//       });
